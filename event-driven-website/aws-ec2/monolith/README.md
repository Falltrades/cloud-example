...
This is an example repository containing Terraform and Ansible code. It contains the code to deploy a demo Event-Driven Pub/Sub application on a unique EC2 instance with `docker-compose`.  
