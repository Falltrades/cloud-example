...
This is an example repository containing Terraform and Ansible code. It contains the code to deploy a basic application (html web page + relational database) on two EC2 instance (one for the application and one for the database) with `docker-compose`.  
