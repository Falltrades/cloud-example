...
This is an example repository containing Terraform and Ansible code. It contains the code to deploy a basic application (html web page + relational database) on a unique EC2 instance with `docker-compose`.  
...
│   ├── docker-compose.yml     # Maybe not the best name for this playbook.
│   ├── inventory
